...
#ifndef WINAPI_DETAIL_REMOVE_CALLING_CONVENTION_HPP
#define WINAPI_DETAIL_REMOVE_CALLING_CONVENTION_HPP

#include <boost/preprocessor/repetition/enum_params.hpp>
#include <boost/preprocessor/repetition/enum_trailing_params.hpp>
#include <boost/preprocessor/repetition/repeat.hpp>

#define WINAPI_CALLING_CONVENTION_MAX_ARGS 10
...
#define WINAPI_REMOVE_CALLING_CONVENTION_TEMPLATE(z, n, convention) \
...
BOOST_PP_REPEAT(
    WINAPI_CALLING_CONVENTION_MAX_ARGS,
    WINAPI_REMOVE_CALLING_CONVENTION_TEMPLATE, __cdecl);

BOOST_PP_REPEAT(
    WINAPI_CALLING_CONVENTION_MAX_ARGS,
    WINAPI_REMOVE_CALLING_CONVENTION_TEMPLATE, __fastcall);

BOOST_PP_REPEAT(
    WINAPI_CALLING_CONVENTION_MAX_ARGS,
    WINAPI_REMOVE_CALLING_CONVENTION_TEMPLATE, __stdcall);
...
BOOST_PP_REPEAT(
    WINAPI_CALLING_CONVENTION_MAX_ARGS,
    WINAPI_REMOVE_CALLING_CONVENTION_TEMPLATE, );
