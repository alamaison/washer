...
#ifndef WINAPI_WINDOW_WINDOW_HPP
#define WINAPI_WINDOW_WINDOW_HPP
#pragma once
...
#include <winapi/window/detail/window_win32.hpp> // set_menu, get_window_rect
...
public:
     ...
     */
    void menu(const winapi::gui::menu::menu_bar& menu)
    {
    ...
    {
        return winapi::gui::window_field<T, WNDPROC>(
    ...
    {
        return winapi::gui::set_window_field<T>(
