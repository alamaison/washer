...
#ifndef WASHER_DYNAMIC_LINK_HPP
#define WASHER_DYNAMIC_LINK_HPP
#pragma once

#include "washer/detail/path_traits.hpp" // choose_path
#include "washer/detail/remove_calling_convention.hpp"
...
namespace detail {
    ...
    public:
        ...
        m_library(library),
        m_function(
            ::washer::proc_address<Signature*>(m_library, function_name))
        {}
...
#endif
    {
        hmodule library = ::washer::load_library(library_path);
