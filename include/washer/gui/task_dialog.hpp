...
#ifndef WASHER_GUI_TASK_DIALOG_HPP
#define WASHER_GUI_TASK_DIALOG_HPP
#pragma once

#include <washer/com/catch.hpp> // WASHER_COM_CATCH
#include <washer/dynamic_link.hpp> // proc_address
...
public:
    ...
    class access_attorney
    {
        ...
        static task_dialog create(const washer::window::window<>& dialog_window)
        {
...
private:
    ...
    task_dialog(const washer::window::window<>& dialog_window) :
        m_dialog_window(dialog_window) {}

    washer::window::window<> m_dialog_window;
};
...
public:
    ...
    class access_attorney
    {
        ...
        static void call(
            const marquee_progress& progress, ::washer::window::window<> dialog)
        {
            progress(dialog);
        }
...
private:
    ...
    void operator()(::washer::window::window<> dialog) const
    {
        ::washer::send_message<wchar_t, BOOL>(
...
public:
    ...
    private:
        ...
        progress_updater(const ::washer::window::window<>& dialog)
    ...
    class access_attorney
    {
        ...
        static progress_updater call(
            const range_progress& progress, ::washer::window::window<> dialog)
        {
...
private:
    ...
    progress_updater operator()(::washer::window::window<> dialog) const
    {
        ::washer::send_message<wchar_t, BOOL>(
...
public:
    ...
    class access_attorney
    {
        ...
        static progress_bar call(const washer::window::window<>& dialog_window)
        {
...
private:
    ...
    progress_bar(const washer::window::window<>& dialog_window) :
       m_dialog_window(dialog_window) {}
...
public:
    ...
    class access_attorney
    {
        ...
        static extended_text_area create(
            const washer::window::window<>& dialog_window)
        {
...
private:
    ...
    extended_text_area(const washer::window::window<>& dialog_window) :
       m_dialog_window(dialog_window) {}
...
private:
    ...
    boost::optional<washer::window::window<>> m_running_dialog;
        ...
        WPARAM /*wparam*/, LPARAM /*lparam*/)
    {
        ...
        {
        case TDN_CREATED:
            m_running_dialog = washer::window::window<>(
                washer::window::window_handle::foster_handle(dialog_window));
...
}}} // namespace washer::gui::task_dialog
