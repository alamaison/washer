...
#ifndef WASHER_GUI_MENU_MENU_HPP
#define WASHER_GUI_MENU_MENU_HPP
#pragma once

#include <washer/gui/menu/basic_menu.hpp>
#include <washer/gui/menu/detail/menu.hpp>
...
BOOST_CONCEPT_ASSERT((boost::Collection<washer::gui::menu::menu>));
BOOST_CONCEPT_ASSERT((boost::Collection<washer::gui::menu::menu_bar>));
#endif

BOOST_CONCEPT_ASSERT((
    boost_concepts::ReadableIterator<washer::gui::menu::menu::iterator>));
BOOST_CONCEPT_ASSERT((
    boost_concepts::ReadableIterator<washer::gui::menu::menu_bar::iterator>));
