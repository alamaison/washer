...
#ifndef WASHER_GUI_MENU_ITEM_COMMAND_ITEM_HPP
#define WASHER_GUI_MENU_ITEM_COMMAND_ITEM_HPP
#pragma once
...
public:
    ...
    virtual command_item& selectability(BOOST_SCOPED_ENUM(washer::gui::menu::selectability) state)
    {
