...
#ifndef WASHER_GUI_PROGRESS_HPP
#define WASHER_GUI_PROGRESS_HPP
#pragma once
...
public:
     ...
     */
    progress(
        const boost::optional< washer::window::window<wchar_t> >& parent,
     ...
     */
    boost::optional< washer::window::window<wchar_t> > window()
    {
        return washer::com::window_from_ole_window(m_progress);
    }
